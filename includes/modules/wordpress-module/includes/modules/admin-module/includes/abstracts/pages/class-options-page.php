...
use WPPF\v1_2_1\WordPress\Admin\Pages\Page;
use WPPF\v1_2_1\WordPress\Admin\Pages\Settings_Section;

if ( ! class_exists( '\WPPF\v1_2_1\WordPress\Admin\Pages\Options_Page', false ) ) {
	...
	abstract class Options_Page extends Page {
		...
		/** @var \WPPF\v1_2_1\WordPress\Admin\Pages\Settings_Section[] The list of Sections attached to this Page. */
		 ...
		 * 
		 * @param \WPPF\v1_2_1\WordPress\Admin\Pages\Settings_Section $Settings_Section The Section to add to this Page.
		 */
