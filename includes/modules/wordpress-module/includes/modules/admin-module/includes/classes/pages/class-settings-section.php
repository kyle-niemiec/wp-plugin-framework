...
namespace WPPF\v1_2_2\WordPress\Admin\Pages;

defined( 'ABSPATH' ) or exit;

use WPPF\v1_2_2\Framework\Utility;
use WPPF\v1_2_2\WordPress\Admin\Pages\Settings_Field;

if ( ! class_exists( '\WPPF\v1_2_2\WordPress\Admin\Pages\Settings_Section', false ) ) {
	...
	final class Settings_Section {
		...
		/** @var \WPPF\v1_2_2\WordPress\Admin\Pages\Options_Page The settings page parent instance */
		protected $Settings_Page;

		/** @var \WPPF\v1_2_2\WordPress\Admin\Pages\Settings_Field[] Fields registered to this Section. */
		 ...
		 * 
		 * @return \WPPF\v1_2_2\WordPress\Admin\Pages\Options_Page $Settings_Page The Settings Page instance.
		 */
		 ...
		 * 
		 * @return \WPPF\v1_2_2\WordPress\Admin\Pages\Settings_Field[] $Settings_Fields The Settings Fields in this Section instance.
		 */
		 ...
		 * 
		 * @param \WPPF\v1_2_2\WordPress\Admin\Pages\Options_Page $Settings_Page The parent Settings Page that these settings belong to.
