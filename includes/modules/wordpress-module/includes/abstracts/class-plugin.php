...
use WPPF\v1_2_2\Plugin\Plugin_Upgrader_Trait;
use WPPF\v1_2_2\WordPress\Post_Type;

if ( ! class_exists( '\WPPF\v1_2_2\WordPress\Plugin', false ) ) {
	...
	abstract class Plugin extends Module {
		...
		/** @var \WPPF\v1_2_2\Admin_Module The admin module, if loaded. */
		 ...
		 * 
		 * @return null|\WPPF\v1_2_2\Admin_Module The Admin Module.
		 */
		...
		protected function __construct( bool $is_submodule = false ) {
			...
			// If this instance directly inherits \WPPF\v1_2_2\Plugin.
		...
		/**
		 * Look for the admin module and load it. It was decided the admin module should stay in \WPPF\v1_2_2 and not belong in \WPPF\v1_2_2\Module
