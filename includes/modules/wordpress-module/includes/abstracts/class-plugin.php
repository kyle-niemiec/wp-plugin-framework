...
namespace WPPF\v1_2_3\WordPress;

defined( 'ABSPATH' ) or exit;

use WPPF\v1_2_3\Framework\Admin_Module;
use WPPF\v1_2_3\Framework\Framework;
use WPPF\v1_2_3\Framework\Module;
use WPPF\v1_2_3\Framework\Utility;
use WPPF\v1_2_3\Plugin\Plugin_Upgrader_Trait;
use WPPF\v1_2_3\WordPress\Post_Type;

if ( ! class_exists( '\WPPF\v1_2_3\WordPress\Plugin', false ) ) {
	...
	abstract class Plugin extends Module {
		...
		/** @var \WPPF\v1_2_3\Admin_Module The admin module, if loaded. */
		 ...
		 * 
		 * @return null|\WPPF\v1_2_3\Admin_Module The Admin Module.
		 */
		...
		protected function __construct( bool $is_submodule = false ) {
			...
			// If this instance directly inherits \WPPF\v1_2_3\Plugin.
		...
		/**
		 * Look for the admin module and load it. It was decided the admin module should stay in \WPPF\v1_2_3 and not belong in \WPPF\v1_2_3\Module
		...
		/**
		 * Search for {@see \WPPF\v1_2_3\WordPress\Post_Type} classes in the Plugin { static::$post_types_dir } and register them.
		 */
