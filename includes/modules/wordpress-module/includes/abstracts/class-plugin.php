...
use WPPF\v1_1_2\Plugin\Plugin_Upgrader_Trait;
use WPPF\v1_1_2\WordPress\Post_Type;

if ( ! class_exists( '\WPPF\v1_1_2\WordPress\Plugin', false ) ) {
	...
	abstract class Plugin extends Module {
		...
		/** @var \WPPF\v1_1_2\Admin_Module The admin module, if loaded. */
		 ...
		 * 
		 * @return null|\WPPF\v1_1_2\Admin_Module The Admin Module.
		 */
		...
		protected function __construct( bool $is_submodule = false ) {
			...
			// If this instance directly inherits \WPPF\v1_1_2.
		...
		/**
		 * Look for the admin module and load it. It was decided the admin module should stay in \WPPF\v1_1_2 and not belong in \WPPF\v1_1_2\Module
		...
		/**
		 * Search for {@see \WPPF\v1_1_2\WordPress\Post_Type} classes in the Plugin { static::$post_types_dir } and register them.
		 */
