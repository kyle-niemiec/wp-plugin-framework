...
if ( ! class_exists( '\WPPF\v1_2_2\WordPress\Post', false ) ) {
	...
	abstract class Post {
		 ...
		 *
		 * @return null|\WPPF\v1_2_2\WordPress\Post_Meta The Post meta if found or NULL.
		 */
		 ...
		 * 
		 * @param \WPPF\v1_2_2\WordPress\Post_Meta
		 */
