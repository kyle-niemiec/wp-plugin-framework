...
if ( ! class_exists( '\WPPF\v1_2_2\WordPress\Post_Type', false ) ) {
	...
	abstract class Post_Type extends Singleton {
		...
		/** @var \WPPF\v1_2_2\WordPress\Admin\Meta_Box[] A list of Meta Boxes to display for this Post Type. */
		 ...
		 * 
		 * @param \WPPF\v1_2_2\WordPress\Admin\Meta_Box
		 */
