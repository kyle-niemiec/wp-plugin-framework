...
if ( ! class_exists( '\WPPF\v1_2_3\WordPress\Meta', false ) ) {
	...
	abstract class Meta {
		...
		/** @var \WPPF\v1_2_3\Meta_Schema The Schema for the Meta. */
		protected $Schema;
		 ...
		 * 
		 * @return \WPPF\v1_2_3\Meta_Schema The Meta schema.
		 */
		 ...
		 * 
		 * @param \WPPF\v1_2_3\Meta_Schema $Schema The Meta Value to use for the schema.
		 */
