...
if ( ! class_exists( '\WPPF\v1_1_2\Admin\Pages\Settings_Field', false ) ) {
	...
	final class Settings_Field {
		...
		/** @var \WPPF\v1_1_2\Admin\Pages\Settings_Section The parent Settings Section. */
		 ...
		 * 
		 * @param \WPPF\v1_1_2\Admin\Pages\Settings_Section $Settings_Section The parent Settings Section.
