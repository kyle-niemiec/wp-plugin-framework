...
if ( ! class_exists( '\WPPF\v1_2_3\Framework\Module', false ) ) {
	...
	abstract class Module extends Singleton {
		 ...
		 */
		public static $includes_dir = 'includes';
		...
		protected function __construct( bool $is_submodule = false ) {
			...
			if ( $this->enabled ) {
				Framework::instance()->get_autoloader()->add_module_directory(
					dirname( $this->get_class_reflection()->getFileName() ),
					static::$includes
				);
