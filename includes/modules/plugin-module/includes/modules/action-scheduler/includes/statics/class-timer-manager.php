...
use WPPF\v1_2_3\Plugin\Action_Scheduler\Timer;

if ( ! class_exists( '\WPPF\v1_2_3\Plugin\Action_Scheduler\Timer_Manager', false ) ) {
	...
	final class Timer_Manager {
		 ...
		 * 
		 * @return null|\WPPF\v1_2_3\Plugin\Action_Scheduler\Timer The Timer instance or NULL.
		 */
		 ...
		 * 
		 * @param \WPPF\v1_2_3\Plugin\Action_Scheduler\Timer $Timer The Timer instance to update.
		 ...
		 * 
		 * @param \WPPF\v1_2_3\Plugin\Action_Scheduler\Timer[] The Timers to save.
		 * 
