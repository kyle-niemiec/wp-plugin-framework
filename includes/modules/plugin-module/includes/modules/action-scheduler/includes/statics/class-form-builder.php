...
if ( ! class_exists( '\WPPF\v1_2_2\Plugin\Action_Scheduler\Form_Builder', false ) ) {
	...
	final class Form_Builder {
		 ...
		 * 
		 * @return null|\WP_Error|\WPPF\v1_2_2\Plugin\Action_Scheduler\Timer The newly created/updated Timer instance.
		 */
