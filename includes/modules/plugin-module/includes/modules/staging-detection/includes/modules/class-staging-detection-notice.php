...
namespace WPPF\v1_2_3\Plugin\Staging_Detection;

defined( 'ABSPATH' ) or exit;

use WPPF\v1_2_3\WordPress\Admin\Admin_Notices;
use WPPF\v1_2_3\Framework\Module;
use WPPF\v1_2_3\Plugin\Staging_Detection;
use WPPF\v1_2_3\Framework\Utility;

if ( ! class_exists( '\WPPF\v1_2_3\Plugin\Staging_Detection\Staging_Detection_Notice', false ) ) {
