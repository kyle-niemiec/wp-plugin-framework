...
use WPPF\v1_2_2\WordPress\Admin\Admin_Notice_Queue;
use WPPF\v1_2_2\WordPress\Plugin;
use WPPF\v1_2_2\WooCommerce\Email_Traits;

if ( ! class_exists( '\WPPF\v1_2_2\WooCommerce\WooCommerce_Plugin', false ) ) {
