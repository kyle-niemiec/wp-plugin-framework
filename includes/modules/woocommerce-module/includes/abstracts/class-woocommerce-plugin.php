...
namespace WPPF\v1_2_3\WooCommerce;

defined( 'ABSPATH' ) or exit;

use WPPF\v1_2_3\WordPress\Admin\Admin_Notice;
use WPPF\v1_2_3\WordPress\Admin\Admin_Notice_Queue;
use WPPF\v1_2_3\WordPress\Plugin;
use WPPF\v1_2_3\WooCommerce\Email_Traits;

if ( ! class_exists( '\WPPF\v1_2_3\WooCommerce\WooCommerce_Plugin', false ) ) {
