...
use WPPF\v1_1_2\Action_Scheduler\Action;
use WPPF\v1_1_2\Utility;

if ( ! class_exists( '\WPPF\v1_1_2\Action_Scheduler\Timer', false ) ) {
	...
	abstract class Timer {
		 ...
		 * Get the Actions.
		 * 
		 * @return \WPPF\v1_1_2\Action_Scheduler\Action[] The Actions.
		 */
		 ...
		 * 
		 * @param \WPPF\v1_1_2\Action_Scheduler\Action $Action The Action to try and add.
		 ...
		 * 
		 * @return null|\WPPF\v1_1_2\Action_Scheduler\Action The Action instance or NULL.
		 */
		...
		/**
		 * A wrapper function for \WPPF\v1_1_2\Action_Scheduler\Timer_Manager::update_timer().
		 * 
		 ...
		 * 
		 * @param \WPPF\v1_1_2\Action_Scheduler\Timer $Timer The Timer instance to merge Actions from.
		 */
		 ...
		 * 
		 * @return null|\WPPF\v1_1_2\Action_Scheduler\Timer The timer that was instantiated or FALSE.
		 */
