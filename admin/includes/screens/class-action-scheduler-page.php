...
namespace WPPF\v1_2_2\Admin\Screens;

defined( 'ABSPATH' ) or exit;

use WPPF\v1_2_2\WordPress\Admin\Pages\Management_Page;
use WPPF\v1_2_2\WPPF_Shadow_Plugin;

if ( ! class_exists( '\WPPF\v1_2_2\Admin\Screens\Action_Scheduler_Page', false ) ) {
