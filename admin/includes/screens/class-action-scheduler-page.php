...
namespace WPPF\v1_2_3\Admin\Screens;

defined( 'ABSPATH' ) or exit;

use WPPF\v1_2_3\WordPress\Admin\Pages\Management_Page;
use WPPF\v1_2_3\WPPF_Shadow_Plugin;

if ( ! class_exists( '\WPPF\v1_2_3\Admin\Screens\Action_Scheduler_Page', false ) ) {
