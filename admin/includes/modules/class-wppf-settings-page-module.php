...
namespace WPPF\v1_2_3\Admin;

defined( 'ABSPATH' ) or exit;

use WPPF\v1_2_3\Admin\Screens\WPPF_Settings_Page;
use WPPF\v1_2_3\Framework\Module;

if ( ! class_exists( '\WPPF\v1_2_3\Admin\WPPF_Settings_Page_Module', false ) ) {
	...
	final class WPPF_Settings_Page_Module extends Module {
		...
		/** @var \WPPF\v1_2_3\WordPress\Admin\Pages\Options_Page $Settings_Page The Settings Page instance. */
