<?php
/**
 * A {@see use WPPF\v1_2_3\WordPress\Post_Meta} for a custom post type, containing configuration and schema information for meta data.
 */
...
if ( ! class_exists( '{{class_name}}', false ) ) {
	...
	final class {{class_name}} extends Post_Meta
	{
		 ...
		 * 
		 * @param \WP_Post $Post The custom post type the {@see use WPPF\v1_2_3\WordPress\Post_Meta} values belong to.
		 */
		 ...
		 * 
		 * @return array The array representation of the {@see use WPPF\v1_2_3\WordPress\Post_Meta}.
		 */
