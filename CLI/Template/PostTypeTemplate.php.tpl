<?php
/**
 * A custom @see WPPF\v1_2_3\WordPress\Post_Type containing configuration information for related functionality.
 */
...
if ( ! class_exists( '{{class_name}}', false ) ) {
	...
	final class {{class_name}} extends Post_Type
	{
		...
		/**
		 * The WordPress custom post type options. @see WPPF\v1_2_3\WordPress\Post_Type for the complete list.
		 * 
