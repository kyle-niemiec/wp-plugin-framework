...
/**
 * A command to create a post type {@see WPPF\v1_2_3\WordPress\Post_Meta} class for the current plugin.
 */
#[AsCommand(
...
final class CreatePostTypeMetaCommand extends PluginCliCommand
{
	...
	/**
	 * Loop prompting the user to provide variable names and data types for a {@see use WPPF\v1_2_3\WordPress\Post_Meta}.
	 * 
